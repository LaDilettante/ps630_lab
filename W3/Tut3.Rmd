...
Use install.packages("ggplot2") before you run this code.
...
The probability to find this data if H0 is true (i.e. there is no relationship between Ozone and Solar.R) is 0.1%. This is strong evidence against H0. Therefore we reject H0 under p < 0.001. Please pay attention to the difference between percent (0-100) and proportions (0-1).
...
If you have a linear regression with multiple independent variables, then the code you need looks like the following:
