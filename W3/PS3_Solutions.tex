...
## 
## data:  vec1 and vec2
## t = -2.281, df = 97.812, p-value = 0.02472
...
\subparagraph{a)} In order to solve this problem, as in the above problems, we need to calculate the following:
...
$Cov(dY_1 + e, fY_2 + g) = \mathbb{E}[(dY_1 + e) * (fY_2 + g)] - \mathbb{E}[dY_1 + e]*\mathbb{E}[fY_2 + g]$ \\

$= \mathbb{E}[dY_1*fY_2 + dY_1*g + e*fY_2 + e*g] - (\mathbb{E}[dY_1] + \mathbb{E}[e])*(\mathbb{E}[fY_2] + \mathbb{E}[g])$ \\

$= \mathbb{E}(dY_1*fY_2) + \mathbb{E}(dY_1*g) + \mathbb{E}(e*fY_2) + \mathbb{E}(e*g)$ - \mathbb{E}(dY_1)*\mathbb{E}(fY_2) - \mathbb{E}(dY_1)*\mathbb{E}(g) - \mathbb{E}(e)*\mathbb{E}(fY_2) - \mathbb{E}(e)*\mathbb{E}(g)$

$= d*f*\mathbb{E}(Y_1*Y_2) + d*g*\mathbb{E}(Y_1) + e*f*\mathbb{E}(Y_2) + e*g - d*\mathbb{E}(Y_1)*f*\mathbb{E}(Y_2) - d*\mathbb{E}(Y_1)*g - e*f*\mathbb{E}(Y_2) - e*g$

$= d*f*\mathbb{E}(Y_1*Y_2) - d*\mathbb{E}(Y_1)*f*\mathbb{E}(Y_2)$

$= d*f*[\mathbb{E}[Y_1*Y_2) - \mathbb{E}(Y_1)*\mathbb{E}(Y_2)]$
