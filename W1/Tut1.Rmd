...
TRUE and FALSE are possible values when conditions are formulated, such as "if" conditions within functions or for loops.
...
3. Topic 3: Basic functions

Unlike a for loop where you specify the elements for which the action is executed, a function is a general formula.

The input of a function is not defined in advance. When you use the function later, you plug some values in.
...
4. Topic 4: Combinations and Permutations
...
This function is used for high values of factorials because they become hard to store.
...
5. Topic 5: Conditional Probability

Next we will consider the Monty Hall problem. This will be an important part of the homework.
...
6. Topic 6: Distributions, histograms, and density plots
...
Start with your homework early. Ask others for help. Work together. But always make sure that you understand the solution fully and write it down yourself and independent from others.