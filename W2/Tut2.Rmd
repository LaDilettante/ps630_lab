...
```{r 'non-log GDP histogram', fig.height=3, fig.width=7}
...
The distribution of GDP is has a long right tail. This is because a country's GDP can go very high but cannot go lower than 0 (this phenomenon is called "left-censored"). Because of this, GDP is NOT normally distributed, and can misbehave in models that assume normality. A common way to deal with this is to take the `log(GDP)` instead.
