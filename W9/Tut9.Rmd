---
title: "Tutorial 9: Data Management and Two-Stage Least Squares (2SLS)"
...
# Rename list elements, remove ".sav"
```
...
X = GDP per capita (explanatory variable, instrumental variable)
...
```{r,tidy=TRUE}
formula_1 <- list ("mu1" = polityiv_update2 ~ l1gdp_pc,
                   "mu2" = l1gdp_pc ~ l1fdi,
                   "inst" = ~ l1fdi)
