...
If you hve missing data in your data frame, you can remove rows that contain missing data. Be careful though as you might remove data you want to use for some parts of your analysis.

```{r}
LDC=na.omit(LDC)

LDC$ecris2[is.na(LDC$ecris2)] <- "No information"
```
