...
Let us conduct an analysis of variance. We are interested in the level of FDI inflows and we look at three different binary variables:

1. Democracy - coded as 0 and 1
2. Open Economy - coded as 0 and 1
3. Economic Crisis - coded as 0 and 1
...
anovamodel=lm(fdignp ~ aclpn*dopen_wacz2*ecris2, data=LDC)
anova(anovamodel)
```
