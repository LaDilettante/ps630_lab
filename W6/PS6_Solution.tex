...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# \\\#\# Attaching package: 'countrycode'\\\#\# \\\#\# The following object is masked from 'package:psData':\\\#\# \\\#\#\ \ \ \  countrycode\_data}}\begin{alltt}
...
(Challenging, but not optional) Figure out which country years appear in WDI data but not in Polity data. Note: There should be 255 unmatched records.
...
\section*{3. Regression with interaction (6 points)}

\subsection*{a) One binary variable}
